...
”Projektin organisaation kuuluu” <kolme> ”Jyväskylän ammattikorkeakoulun IT-instituutin opiskelijaa, projektiryhmän ohjaajat sekä toimeksiantajan edustajat. Organisaatiokaavio on esitetty liitteessä 1.”
Projektiryhmä
...
”Projektiryhmien dokumentaatiosta IT-instituutille jäävä osa tallennetaan Optimaan.” Toimeksiantajan tulee selkeästi määritellä, mitkä dokumentit voidaan jättää opiksi seuraaville projekteille. Tyypillisesti eri suunnitelmat ja loppuraportti ovat tällaisia dokumentteja. 
...
”Projekti päättyy p.k.vvv, jolloin projektisopimuksen voimassaoloaika päättyy.”
